...
async function getFrameScreenShot(videoPath) {
  ...
  return await new Promise((res, rej) => {
    ...
    (0, import_fluent_ffmpeg.default)(videoPath).on("end", () => {
      if (!import_fs.default.existsSync(tempThumbnailPath))
...
// scripts/utils/Bases/ffmpeg/index.ts
import_fluent_ffmpeg3.default.setFfmpegPath(process.env.ffmpegPath);
import_fluent_ffmpeg3.default.setFfprobePath(process.env.ffmpegProbe);
