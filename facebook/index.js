    ...
    module2.exports = function(proto) {
      proto.mergeAdd = proto.addInput = proto.input = function(source) {
        ...
        if (typeof source !== "string") {
          ...
          isFile3 = !protocol || protocol[0] === "file";
        }
    ...
    module2.exports = function(proto) {
      proto.addOutput = proto.output = function(target, pipeopts) {
        ...
        if (target && !("target" in this._currentOutput)) {
          ...
          this._currentOutput.isFile = isFile3;
    ...
    module2.exports = function(proto) {
      proto.usingPreset = proto.preset = function(preset) {
        if (typeof preset === "function") {
          ...
          try {
            var modulePath = path8.join(this.options.presets, preset);
...
var require_async = __commonJS({
  "node_modules/fluent-ffmpeg/node_modules/async/lib/async.js"(exports2, module2) {
    ...
    (function() {
      ...
      var _each = function(arr, iterator2) {
        if (arr.forEach) {
          return arr.forEach(iterator2);
        }
        for (var i = 0; i < arr.length; i += 1) {
          iterator2(arr[i], i, arr);
        }
      };
      var _map = function(arr, iterator2) {
        if (arr.map) {
          return arr.map(iterator2);
        }
        var results = [];
        _each(arr, function(x2, i, a) {
          results.push(iterator2(x2, i, a));
        });
        return results;
      };
      var _reduce = function(arr, iterator2, memo) {
        if (arr.reduce) {
          return arr.reduce(iterator2, memo);
        }
        _each(arr, function(x2, i, a) {
          memo = iterator2(memo, x2, i, a);
        });
        return memo;
      };
      ...
      async.each = function(arr, iterator2, callback) {
        ...
        var completed = 0;
        _each(arr, function(x2) {
          iterator2(x2, only_once(function(err) {
            if (err) {
              callback(err);
              callback = function() {
              };
      ...
      async.eachSeries = function(arr, iterator2, callback) {
        callback = callback || function() {
        };
        if (!arr.length) {
          return callback();
        ...
        var iterate = function() {
          iterator2(arr[completed], function(err) {
            if (err) {
              callback(err);
              callback = function() {
              };
      ...
      async.eachLimit = function(arr, limit, iterator2, callback) {
        var fn = _eachLimit(limit);
        fn.apply(null, [arr, iterator2, callback]);
      };
      async.forEachLimit = async.eachLimit;
      var _eachLimit = function(limit) {
        return function(arr, iterator2, callback) {
          callback = callback || function() {
          };
          ...
          (function replenish() {
            ...
            while (running < limit && started < arr.length) {
              started += 1;
              running += 1;
              iterator2(arr[started - 1], function(err) {
                if (err) {
                  callback(err);
                  callback = function() {
                  };
      ...
      var _asyncMap = function(eachfn, arr, iterator2, callback) {
        var results = [];
        arr = _map(arr, function(x2, i) {
          return { index: i, value: x2 };
        });
        eachfn(arr, function(x2, callback2) {
          iterator2(x2.value, function(err, v) {
            results[x2.index] = v;
            callback2(err);
          });
        }, function(err) {
      ...
      async.mapLimit = function(arr, limit, iterator2, callback) {
        return _mapLimit(limit)(arr, iterator2, callback);
      };
      var _mapLimit = function(limit) {
        return doParallelLimit(limit, _asyncMap);
      };
      async.reduce = function(arr, memo, iterator2, callback) {
        async.eachSeries(arr, function(x2, callback2) {
          iterator2(memo, x2, function(err, v) {
            memo = v;
            callback2(err);
          });
        }, function(err) {
      ...
      async.reduceRight = function(arr, memo, iterator2, callback) {
        var reversed = _map(arr, function(x2) {
          return x2;
        }).reverse();
        async.reduce(reversed, memo, iterator2, callback);
      };
      async.foldr = async.reduceRight;
      var _filter = function(eachfn, arr, iterator2, callback) {
        var results = [];
        arr = _map(arr, function(x2, i) {
          return { index: i, value: x2 };
        });
        eachfn(arr, function(x2, callback2) {
          iterator2(x2.value, function(v) {
            if (v) {
              results.push(x2);
            }
            callback2();
          ...
          callback(_map(results.sort(function(a, b2) {
      ...
      var _reject = function(eachfn, arr, iterator2, callback) {
        var results = [];
        arr = _map(arr, function(x2, i) {
          return { index: i, value: x2 };
        });
      ...
      var _detect = function(eachfn, arr, iterator2, main_callback) {
        eachfn(arr, function(x2, callback) {
          iterator2(x2, function(result) {
            if (result) {
              main_callback(x2);
      ...
      async.some = function(arr, iterator2, main_callback) {
        async.each(arr, function(x2, callback) {
          iterator2(x2, function(v) {
            if (v) {
              main_callback(true);
              main_callback = function() {
              };
      ...
      async.every = function(arr, iterator2, main_callback) {
        async.each(arr, function(x2, callback) {
          iterator2(x2, function(v) {
            if (!v) {
              main_callback(false);
      ...
      async.sortBy = function(arr, iterator2, callback) {
        async.map(arr, function(x2, callback2) {
          iterator2(x2, function(err, criteria) {
            if (err) {
              callback2(err);
            } else {
          ...
          if (err) {
            ...
            var fn = function(left, right) {
              var a = left.criteria, b2 = right.criteria;
              return a < b2 ? -1 : a > b2 ? 1 : 0;
            };
            callback(null, _map(results.sort(fn), function(x2) {
              return x2.value;
            }));
          }
        });
      ...
      async.auto = function(tasks, callback) {
        ...
        _each(keys, function(k2) {
          var task = tasks[k2] instanceof Function ? [tasks[k2]] : tasks[k2];
          ...
          var ready = function() {
            return _reduce(requires, function(a, x2) {
              return a && results.hasOwnProperty(x2);
            }, true) && !results.hasOwnProperty(k2);
          };
          if (ready()) {
      ...
      var _parallel = function(eachfn, tasks, callback) {
        ...
        if (tasks.constructor === Array) {
          ...
          var results = {};
          eachfn.each(_keys(tasks), function(k2, callback2) {
            tasks[k2](function(err) {
              var args = Array.prototype.slice.call(arguments, 1);
              if (args.length <= 1) {
                args = args[0];
              }
      ...
      async.series = function(tasks, callback) {
        ...
        if (tasks.constructor === Array) {
          ...
          var results = {};
          async.eachSeries(_keys(tasks), function(k2, callback2) {
            tasks[k2](function(err) {
              var args = Array.prototype.slice.call(arguments, 1);
              if (args.length <= 1) {
                args = args[0];
      ...
      var _concat = function(eachfn, arr, fn, callback) {
        var r = [];
        eachfn(arr, function(x2, cb) {
          fn(x2, function(err, y2) {
            r = r.concat(y2 || []);
            cb(err);
          });
        }, function(err) {
      ...
      async.whilst = function(test2, iterator2, callback) {
        if (test2()) {
          iterator2(function(err) {
            if (err) {
              return callback(err);
            }
            async.whilst(test2, iterator2, callback);
          });
        } else {
          callback();
        }
      };
      async.doWhilst = function(iterator2, test2, callback) {
        iterator2(function(err) {
          if (err) {
            return callback(err);
          }
          if (test2()) {
            async.doWhilst(iterator2, test2, callback);
          } else {
            callback();
          }
        });
      };
      async.until = function(test2, iterator2, callback) {
        if (!test2()) {
          iterator2(function(err) {
            if (err) {
              return callback(err);
            }
            async.until(test2, iterator2, callback);
          });
        } else {
          callback();
        }
      };
      async.doUntil = function(iterator2, test2, callback) {
        iterator2(function(err) {
          if (err) {
            return callback(err);
          }
          if (!test2()) {
            async.doUntil(iterator2, test2, callback);
          } else {
            callback();
          }
        });
      ...
      async.queue = function(worker, concurrency) {
        ...
        function _insert(q3, data, pos, callback) {
          ...
          _each(data, function(task) {
            ...
            if (pos) {
              q3.tasks.unshift(item);
            } else {
              q3.tasks.push(item);
            }
            if (q3.saturated && q3.tasks.length === concurrency) {
              q3.saturated();
            }
            async.setImmediate(q3.process);
          });
        }
        var workers = 0;
        var q2 = {
          ...
          push: function(data, callback) {
            _insert(q2, data, false, callback);
          },
          unshift: function(data, callback) {
            _insert(q2, data, true, callback);
          },
          process: function() {
            if (workers < q2.concurrency && q2.tasks.length) {
              var task = q2.tasks.shift();
              if (q2.empty && q2.tasks.length === 0) {
                q2.empty();
              }
              workers += 1;
              var next = function() {
                ...
                if (q2.drain && q2.tasks.length + workers === 0) {
                  q2.drain();
                }
                q2.process();
              };
      ...
      async.times = function(count, iterator2, callback) {
        var counter = [];
        for (var i = 0; i < count; i++) {
          counter.push(i);
        }
        return async.map(counter, iterator2, callback);
      };
      async.timesSeries = function(count, iterator2, callback) {
        var counter = [];
        for (var i = 0; i < count; i++) {
          counter.push(i);
        }
        return async.mapSeries(counter, iterator2, callback);
      };
    ...
    module2.exports = function(proto) {
      proto._spawnFfmpeg = function(args, options, processCB, endCB) {
        ...
        this._getFfmpegPath(function(err, command) {
          ...
          var ffmpegProc = spawn2(command, args, options);
                ...
                if (flvmeta.length) {
                  self2._getFlvtoolPath(function(err3, flvtool) {
                    ...
                    async.each(
                      flvmeta,
                      function(output, cb) {
                        spawn2(flvtool, ["-U", output.target], { windowsHide: true }).on("error", function(err4) {
      ...
      proto.renice = function(niceness) {
        if (!utils.isWindows) {
          ...
          if (this.ffmpegProc) {
            ...
            var renice = spawn2("renice", [niceness, "-p", pid], { windowsHide: true });
    ...
    module2.exports = function(proto) {
      ...
      proto._getFfmpegPath = function(callback) {
        ...
        async.waterfall([
          ...
          function(ffmpeg6, cb) {
            if (ffmpeg6.length) {
              return cb(null, ffmpeg6);
            }
            utils.which("ffmpeg", function(err, ffmpeg7) {
              cb(err, ffmpeg7);
            });
          }
        ], function(err, ffmpeg6) {
          if (err) {
            callback(err);
          } else {
            callback(null, cache.ffmpegPath = ffmpeg6 || "");
          }
        });
      };
      proto._getFfprobePath = function(callback) {
        ...
        async.waterfall([
          ...
          function(ffprobe, cb) {
            ...
            self2._getFfmpegPath(function(err, ffmpeg6) {
              if (err) {
                cb(err);
              } else if (ffmpeg6.length) {
                var name = utils.isWindows ? "ffprobe.exe" : "ffprobe";
                var ffprobe2 = path8.join(path8.dirname(ffmpeg6), name);
  ...
  "node_modules/fluent-ffmpeg/lib/ffprobe.js"(exports2, module2) {
    ...
    module2.exports = function(proto) {
      proto.ffprobe = function() {
        ...
        this._getFfprobePath(function(err, path8) {
          if (err) {
          ...
          var ffprobe = spawn2(path8, ["-show_streams", "-show_format"].concat(options, src), { windowsHide: true });
          if (input.isStream) {
        ...
        async.waterfall([
          ...
          function fixPattern(next) {
            ...
            if (config.timemarks.length > 1 && !pattern.match(/%(s|0*i)/)) {
              var ext = path8.extname(pattern);
              pattern = path8.join(path8.dirname(pattern), path8.basename(pattern, ext) + "_%i" + ext);
            }
            next(null, pattern);
          },
          ...
          function replaceFilenameTokens(pattern, next) {
            if (pattern.match(/%[bf]/)) {
              ...
              pattern = pattern.replace(/%f/g, path8.basename(source)).replace(/%b/g, path8.basename(source, path8.extname(source)));
            }
            next(null, pattern);
          },
          ...
          for (var i2 = 0; i2 < count; i2++) {
            ...
            self2.output(path8.join(config.folder, filenames[i2])).frames(1).map(stream4);
            if (i2 > 0) {
...
var require_fluent_ffmpeg = __commonJS({
  "node_modules/fluent-ffmpeg/lib/fluent-ffmpeg.js"(exports2, module2) {
    ...
    function FfmpegCommand(input, options) {
      ...
      options.presets = options.presets || options.preset || path8.join(__dirname, "presets");
    ...
    util4.inherits(FfmpegCommand, EventEmitter3);
    ...
    FfmpegCommand.setFfmpegPath = function(path9) {
      new FfmpegCommand().setFfmpegPath(path9);
    };
    FfmpegCommand.setFfprobePath = function(path9) {
      new FfmpegCommand().setFfprobePath(path9);
    };
    FfmpegCommand.setFlvtoolPath = function(path9) {
      new FfmpegCommand().setFlvtoolPath(path9);
    };
...
__export(index_exports, {
  ...
  getData: () => getData2,
  navigate: () => navigate,
  predictInputString: () => predictInputString
});
...
function getQualityFromResolution(width, height) {
  ...
  for (const q2 of qualities) {
    const diff = Math.abs(height - q2.height);
    if (diff < minDiff) {
      closest = q2;
      minDiff = diff;
    }
...
var ee = __toESM(require("fs"), 1);
var import_path2 = __toESM(require("path"), 1);
var import_buffer = require("buffer");
var import_stream = require("stream");
var import_path3 = __toESM(require("path"), 1);
var import_fs = __toESM(require("fs"), 1);
var Re = __toESM(require("https"), 1);
var Ee = __toESM(require("http"), 1);
var import_url2 = require("url");
var y = __toESM(require("fs"), 1);
var le = __toESM(require("fs"), 1);
var k = __toESM(require("path"), 1);
var c = __toESM(require("fs"), 1);
var T = __toESM(require("path"), 1);
...
var $ = "~ytdlp-progress-%(progress)#j";
function z(e, t = 2) {
  let r = Number(e);
  if (r === 0 || isNaN(r)) return r + " Bytes";
  let s = 1024, i = t < 0 ? 0 : t, n = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], o = Math.floor(Math.log(r) / Math.log(s));
  return parseFloat((r / Math.pow(s, o)).toFixed(i)) + " " + n[o];
}
function De(e, t, r) {
  let s = Math.pow(r || 10, t);
  return Math.round(e * s) / s;
}
function _e(e) {
  e = Number(e);
  let t = Math.floor(e / 3600), r = Math.floor(e % 3600 / 60), s = Math.floor(e % 3600 % 60), i = t > 0 ? t + (t == 1 ? " hour, " : " hours, ") : "", n = r > 0 ? r + (r == 1 ? " minute, " : " minutes, ") : "", o = s >= 0 ? s + (s == 1 ? " second" : " seconds") : "";
  return i + n + o;
}
function g(e) {
  try {
    if (!e.includes("~ytdlp-progress-")) throw new Error();
    let t = e.trim().replace("~ytdlp-progress-", "");
    if (!t) throw new Error();
    let r = JSON.parse(t), s = (l) => {
      if (l == null || l === "NA") return;
      let f = Number(l);
      return isNaN(f) ? void 0 : f;
    }, i = s(r.downloaded_bytes), n = s(r.total_bytes) ?? s(r.total_bytes_estimate), o = s(r.speed), a = s(r.eta), u = i !== void 0 && n !== void 0 && n > 0 ? De(100 * i / n, 2) : void 0;
    return { filename: r.filename, status: r.status, downloaded: i, downloaded_str: i !== void 0 ? z(i) : void 0, total: n, total_str: n !== void 0 ? z(n) : void 0, speed: o, speed_str: o !== void 0 ? z(o) + "/s" : void 0, eta: a, eta_str: a !== void 0 ? _e(a) : void 0, percentage: u, percentage_str: u !== void 0 ? u + "%" : void 0 };
  } catch {
    return;
  }
}
function Y(e, t = {}) {
  return new Promise((r, s) => {
    let o = (new import_url2.URL(e).protocol === "https:" ? Re : Ee).get(e, t, (a) => {
      if (a.statusCode >= 300 && a.statusCode < 400 && a.headers.location) {
        let u = new import_url2.URL(a.headers.location, e).toString();
        Y(u, t).then(r).catch(s);
        return;
      }
      r(a);
    });
...
async function F(e, t) {
  try {
    let r = y.createWriteStream(t), s = await Y(e);
    if (s.statusCode !== 200) throw r.close(), y.unlinkSync(t), new Error(`Failed to download file: ${s.statusCode} ${s.statusMessage}`);
    let i = parseInt(s.headers["content-length"] || "0", 10), n = 0;
    return s.on("data", (o) => {
      n += o.length;
      let a = n / i * 100;
      process.stdout.write(`Progress: ${Math.round(a)}%\r`);
    }), s.pipe(r), new Promise((o, a) => {
      r.on("finish", () => {
        r.close(), console.log(`
Download complete!`), o();
      }), r.on("error", (u) => {
        r.close(), y.unlinkSync(t), a(u);
      }), s.on("error", (u) => {
        r.close(), y.unlinkSync(t), a(u);
      });
    });
  } catch (r) {
    throw y.existsSync(t) && y.unlinkSync(t), r;
  }
}
async function ue(e, t = {}) {
  let r = await Y(e, t);
  if (r.statusCode !== 200) throw new Error(`Failed to fetch text: ${r.statusCode} ${r.statusMessage}`);
  return new Promise((s, i) => {
    let n = "";
    r.setEncoding("utf8"), r.on("data", (o) => {
      n += o;
    }), r.on("end", () => s(n)), r.on("error", i);
  });
}
function Be(e) {
  let t = e;
  for (; ; ) {
    if (le.existsSync(k.join(t, "package.json"))) return t;
    let r = k.dirname(t);
    if (r === t) return e;
    t = r;
  }
...
var fe = Be(h);
var b = k.join(fe, "bin");
var ht = k.join(fe, "package.json");
var Te = "https://github.com/iqbal-rashed/ytdlp-nodejs/releases/download/ffmpeg-latest";
...
function de() {
  let e = process.platform, t = process.arch;
  if (!q[e] || !q[e][t]) throw new Error(`No FFmpeg build available for platform: ${e}, architecture: ${t}`);
  return q[e][t];
}
async function G(e) {
  let t = e || b, r = A();
  ...
  try {
    ...
    let i = s.map((o) => `${Te}/${o}`), n = s.map((o) => import_path3.default.join(t, String(o.split("-").pop())));
    import_fs.default.existsSync(t) || import_fs.default.mkdirSync(t, { recursive: true }), console.log("Downloading FFmpeg and FFprobe...");
    for (let o = 0; o < s.length; o++) {
      let a = i[o], u = n[o];
      console.log("Downloading...", import_path3.default.basename(a)), await F(a, u);
    }
    if (process.platform !== "win32") for (let o of n) import_fs.default.chmodSync(o, 493);
    return A();
  } catch (s) {
...
function A() {
  try {
    ...
    let t = import_path3.default.join(b, String(e[0].split("-").pop()));
    if (!import_fs.default.existsSync(t)) throw new Error("FFmpeg binary not found. Please download it first.");
    return t;
  } catch {
    return;
  }
}
var H = "https://github.com/yt-dlp/yt-dlp/releases/latest/download";
var L = { win32: { x64: "yt-dlp.exe", ia32: "yt-dlp_x86.exe", arm64: "yt-dlp_arm64.exe" }, linux: { x64: "yt-dlp_linux", armv7l: "yt-dlp_linux_armv7l", aarch64: "yt-dlp_linux_aarch64", arm64: "yt-dlp_linux_aarch64" }, darwin: { x64: "yt-dlp_macos", arm64: "yt-dlp_macos" }, android: { arm64: "yt-dlp" } };
function Oe() {
  return process.platform !== "linux" ? false : !process.report?.getReport()?.header?.glibcVersionRuntime;
}
function ce(e = process.platform, t = process.arch, r = Oe()) {
  if (e === "linux" && r) {
    if (t === "x64") return "yt-dlp_musllinux";
    if (t === "arm64" || t === "aarch64") return "yt-dlp_musllinux_aarch64";
  }
  if (!L[e] || !L[e][t]) throw new Error(`No yt-dlp build available for ${e} ${t}`);
  return L[e][t];
}
async function N(e) {
  let t = e || b, r = ce(), s = `${H}/${r}`, i = T.join(t, r);
  if (c.existsSync(i)) return i;
  console.log("Downloading yt-dlp...", s), c.existsSync(t) || c.mkdirSync(t, { recursive: true });
  try {
    return await F(s, i), console.log(`yt-dlp downloaded successfully to: ${i}`), process.platform !== "win32" && c.chmodSync(i, 493), i;
  } catch (o) {
    throw console.error(`Download failed: ${o}`), o;
  }
}
async function Ve(e, t, r) {
  c.existsSync(e) || c.mkdirSync(e, { recursive: true });
  let s = T.join(e, t), i = T.join(e, `.${t}.${process.pid}.${Date.now()}.download`);
  try {
    await F(`${H}/${t}`, i), process.platform !== "win32" && c.chmodSync(i, 493);
    let n = await he(i);
    if (n.toLowerCase() !== r.toLowerCase()) throw new Error(`Checksum mismatch for ${t}. Expected ${r}, got ${n}`);
    let o = `${s}.previous`;
    c.existsSync(o) && c.unlinkSync(o), c.existsSync(s) && c.renameSync(s, o);
    try {
      c.renameSync(i, s), c.existsSync(o) && c.unlinkSync(o);
    } catch (a) {
      throw c.existsSync(o) && c.renameSync(o, s), a;
    }
    return s;
  } finally {
    c.existsSync(i) && c.unlinkSync(i);
  }
}
async function he(e) {
  return new Promise((t, r) => {
    let s = import_crypto3.default.createHash("sha256"), i = c.createReadStream(e);
    i.on("data", (n) => s.update(n)), i.on("end", () => t(s.digest("hex"))), i.on("error", r);
  });
}
async function $e(e) {
  try {
    let r = (await ue(`${H}/SHA2-256SUMS`)).split(/\r?\n/);
    for (let s of r) {
      let [i, n] = s.trim().split(/\s+/);
      if (n?.replace(/^\*/, "") === e) return i || void 0;
    }
    return;
  } catch {
    return;
...
async function Z(e) {
  let t = e || b, r = ce(), s = await N(t), i = await $e(r);
  return i ? ((await he(s)).toLowerCase() !== i.toLowerCase() && (s = await Ve(t, r, i)), { path: s, verified: true, checksum: i }) : { path: s, verified: false };
}
function I() {
  let e = process.platform, t = process.arch;
  try {
    let r = L[e][t], s = T.join(b, r);
    if (!c.existsSync(s)) throw new Error("Ytdlp binary not found. Please download it first.");
    return s;
  } catch {
    return;
  }
...
function w(e) {
  let t = e.trim();
  if (!t.startsWith("__YTDLP_BEFORE_DL__:")) return null;
  let r = t.replace("__YTDLP_BEFORE_DL__:", "").trim();
  try {
    let s = r.replace(/:"N\/A"/g, ":null").replace(/:"NA"/g, ":null").replace(/:""/, ':"NA"'), i = JSON.parse(s), n = {};
...
var Ce = /^ERROR:\s*(?:\[.+?\]\s*)?(.+)/m;
var Le = [/ERROR:\s*\[.*?\]\s*.*?:\s*Sign in to confirm/i, /ERROR:\s*\[.*?\]\s*Unable to extract/i, /ERROR:\s*\[.*?\]\s*This video is unavailable/i, /ERROR:\s*\[.*?\]\s*Video unavailable/i, /ERROR:\s*\[.*?\]\s*Private video/i, /ERROR:\s*\[.*?\]\s*.*?requires premium/i, /ERROR:\s*\[.*?\]\s*This live event has ended/i, /ERROR:\s*\[.*?\]\s*.*?is not available/i, /ERROR:\s*No video formats found/i, /ERROR:\s*Unsupported URL/i];
function pe(e) {
  if (!e) return { hasError: false };
  let t = e.match(Ce);
  return t ? { hasError: true, message: t[1]?.trim(), fullError: t[0] } : { hasError: false };
}
function Ne(e) {
  return e ? Le.some((t) => t.test(e)) : false;
}
function me(e, t) {
  let s = pe(e).message || "Unknown yt-dlp error";
  return t != null && t !== 0 && (s = `yt-dlp exited with code ${t}: ${s}`), new Error(s);
}
function S(e, t, r) {
  let { exitCodeOnly: s = false, fatalOnly: i = false } = r || {};
  if (t !== 0 && t !== null) return me(e, t);
  if (s) return;
  if (pe(e).hasError) return i && !Ne(e) ? void 0 : me(e);
}
function ge({ url: e, options: t, ffmpegPath: r, withProgressTemplate: s, extra: i }) {
  let n = V(t || {});
  return r && n.push("--ffmpeg-location", r), s && n.push("--progress-template", $), i && i.length > 0 && n.push(...i), e && n.push("--", e), n;
}
var x = class extends import_node_events.EventEmitter {
  constructor(r, s) {
    super();
    this.binaryPath = "";
    this.videoUrl = "";
    this.extraArgs = {};
    this.rawArgs = [];
    this.videoUrl = r, this.binaryPath = s?.binaryPath || I() || "", this.ffmpegPath = s?.ffmpegPath || A(), (!this.binaryPath || !import_node_fs.default.existsSync(this.binaryPath)) && console.error(new Error("yt-dlp binary not found. Please install yt-dlp or specify correct binaryPath in options.")), this.ffmpegPath && !import_node_fs.default.existsSync(this.ffmpegPath) && console.error(new Error(`FFmpeg binary not found at: ${this.ffmpegPath}. Please install FFmpeg or specify correct ffmpegPath.`));
  }
  setBinaryPath(r) {
    return this.binaryPath = r, this;
  }
  setFfmpegPath(r) {
    return this.ffmpegPath = r, this;
  }
  format(r) {
    return this.formatValue = r, this;
  }
  filter(r) {
    let s = typeof this.formatValue == "object" ? this.formatValue : {};
    return this.formatValue = { ...s, filter: r }, this;
  }
  quality(r) {
    let s = typeof this.formatValue == "object" ? this.formatValue : {};
    return this.formatValue = { filter: this.formatValue, ...s, quality: r }, this;
  }
  type(r) {
    let s = typeof this.formatValue == "object" ? this.formatValue : {};
    return this.formatValue = { filter: this.formatValue, ...s, type: r }, this;
  }
  options(r) {
    return this.extraArgs = { ...this.extraArgs, ...r }, this;
  }
  rateLimit(r) {
    return this.extraArgs.limitRate = r, this;
  }
  cookies(r) {
    return this.extraArgs.cookies = r, this;
  }
  cookiesFromBrowser(r) {
    return this.extraArgs.cookiesFromBrowser = r, this;
  }
  proxy(r) {
    return this.extraArgs.proxy = r, this;
  }
  addOption(r, s) {
    return this.extraArgs[r] = s, this;
  }
  addArgs(...r) {
    return this.rawArgs.push(...r), this;
  }
  extractAudio(r) {
    return this.extraArgs.extractAudio = true, r && (this.extraArgs.audioFormat = r), this;
  }
  audioFormat(r) {
    return this.extraArgs.audioFormat = r, this;
  }
  audioQuality(r) {
    return this.extraArgs.audioQuality = r, this;
  }
  embedThumbnail() {
  ...
  subLangs(r) {
    return this.extraArgs.subLangs = r, this;
  }
  writeThumbnail() {
    return this.extraArgs.writeThumbnail = true, this;
  }
  username(r) {
    return this.extraArgs.username = r, this;
  }
  password(r) {
    return this.extraArgs.password = r, this;
  }
  playlistStart(r) {
    return this.extraArgs.playlistStart = r, this;
  }
  playlistEnd(r) {
    return this.extraArgs.playlistEnd = r, this;
  }
  playlistItems(r) {
    return this.extraArgs.playlistItems = r, this;
  }
  buildFormatArgs() {
  ...
  buildBaseArgs(r = []) {
    ...
    return ge({ url: this.videoUrl, options: this.extraArgs, ffmpegPath: this.ffmpegPath, withProgressTemplate: true, extra: [...s, ...r, ...this.rawArgs] });
  }
  debugPrint(r = true) {
    return this.extraArgs.debugPrintCommandLine = r, this;
  }
  getCommand() {
    let r = this.buildArgs();
    return `${this.binaryPath} ${r.join(" ")}`;
  }
  getArguments() {
  ...
  printDebugCommandLine(r) {
    if (this.extraArgs.debugPrintCommandLine) {
      let s = `${this.binaryPath} ${r.join(" ")}`;
...
var _ = class extends x {
  ...
  once(t, r) {
    return super.once(t, r);
  }
  emit(t, ...r) {
    return super.emit(t, ...r);
  }
  output(t) {
    return this.outputDir = t, this;
  }
  setOutputTemplate(t) {
    return this.outputPath = t, this;
  }
  skipDownload() {
  ...
  buildArgs() {
    ...
    this.outputDir && (t.output = `${this.outputDir}/%(title)s.%(ext)s`), this.outputPath && (t.output = this.outputPath);
    let r = this.extraArgs;
    this.extraArgs = t;
    let s = [...M()];
    this.listenerCount("beforeDownload") > 0 && s.unshift("--print", D());
    let i = this.buildBaseArgs(s);
    return this.extraArgs = r, i;
  }
  run() {
    return this.resultPromise ? this.resultPromise : (this.resultPromise = new Promise((t, r) => {
      try {
        this.validateBinaryPath();
        let s = this.buildArgs(), i = `${this.binaryPath} ${s.join(" ")}`;
        this.printDebugCommandLine(s), this.process = (0, import_node_child_process.spawn)(this.binaryPath, s), this.emit("start", i);
        let n = "", o = "";
  ...
  then(t, r) {
    return this.run().then(t, r);
  }
  catch(t) {
    return this.run().catch(t);
  }
  finally(t) {
    return this.run().finally(t);
  }
};
var R = class extends x {
  ...
  once(r, s) {
    return super.once(r, s);
  }
  emit(r, ...s) {
    return super.emit(r, ...s);
  }
  buildArgs() {
    let r = ["-o", "-", "--no-playlist", "--progress", "--no-quiet"];
    return this.listenerCount("beforeDownload") > 0 && r.push("--print", D()), this.buildBaseArgs(r);
  }
  startStream() {
    if (this.started) return this.passThrough;
    this.validateBinaryPath(), this.started = true, this.passThrough = new import_node_stream.PassThrough();
    let r = this.buildArgs(), s = `${this.binaryPath} ${r.join(" ")}`;
    this.printDebugCommandLine(r), this.process = (0, import_node_child_process2.spawn)(this.binaryPath, r, { shell: false }), this.emit("start", s), this.process.stdout?.on("data", (n) => {
  ...
  pipe(r, s) {
    ...
    return new Promise((o, a) => {
      n.pipe(r, s), r.on("finish", () => {
        o({ bytes: this.totalBytes, duration: Date.now() - i });
      }), r.on("error", a), this.passThrough.on("error", a);
    });
  }
  pipeAsync(r, s) {
    return this.pipe(r, s);
  }
  async toBuffer() {
    let r = [];
    return new Promise((s, i) => {
...
var P = class extends x {
  ...
  buildArgs() {
    let r = [], s = [...M()];
    return this.listenerCount("beforeDownload") > 0 && s.unshift("--print", D()), this.listenerCount("afterDownload") > 0 && s.push("--print", "after_move:filepath"), this.buildBaseArgs([...r, ...s]);
  }
  startStream() {
    if (this.started) return this.passThrough;
    this.validateBinaryPath(), this.started = true, this.passThrough = new import_node_stream2.PassThrough(), this.output = "";
    let r = this.buildArgs();
    r.includes("--no-playlist") || (r = ["--no-playlist", ...r]);
    let s = `${this.binaryPath} ${r.join(" ")}`;
    return this.printDebugCommandLine(r), this.process = (0, import_node_child_process3.spawn)(this.binaryPath, r, { shell: false }), this.emit("start", s), this.process.stdout?.on("data", (i) => {
  ...
  exec() {
    return this.resultPromise ? this.resultPromise : (this.resultPromise = new Promise((r, s) => {
      try {
        this.validateBinaryPath();
        let i = this.buildArgs(), n = `${this.binaryPath} ${i.join(" ")}`;
        this.printDebugCommandLine(i), this.process = (0, import_node_child_process3.spawn)(this.binaryPath, i, { shell: false }), this.emit("start", n);
        let o = "", a = "";
        this.process.stdout?.on("data", (u) => {
          ...
          let f = j(o), d = K(o), p = { stdout: o, stderr: a, exitCode: u, command: n, info: d, output: f, filePaths: d.map((E) => E?.filepath ?? "").filter(Boolean) };
          this.emit("complete", p), this.emit("end"), r(p);
        });
      } catch (i) {
        s(i);
      }
  ...
  then(r, s) {
    return this.exec().then(r, s);
  }
  catch(r) {
    return this.exec().catch(r);
  }
  finally(r) {
    return this.exec().finally(r);
  }
};
var Pe = class {
  constructor(t) {
    this.binaryPath = t?.binaryPath || I() || "", this.ffmpegPath = t?.ffmpegPath || A(), (!this.binaryPath || !ee.existsSync(this.binaryPath)) && console.error(new Error("yt-dlp binary not found. Please install yt-dlp or specify correct binaryPath in options.")), this.ffmpegPath && !ee.existsSync(this.ffmpegPath) && console.error(new Error(`FFmpeg binary not found at: ${this.ffmpegPath}. Please install FFmpeg or specify correct ffmpegPath.`));
  }
  async checkInstallationAsync(t) {
    return new Promise((r, s) => {
      if (t?.ffmpeg && !this.ffmpegPath) return s(new Error("FFmpeg path is not set"));
      let i = (0, import_child_process.spawn)(this.binaryPath, ["--version"]), n = false, o = !t?.ffmpeg;
      i.on("error", () => n = false), i.on("exit", (a) => {
        if (n = a === 0, t?.ffmpeg) {
          let u = (0, import_child_process.spawn)(this.ffmpegPath, ["-version"]);
  ...
  checkInstallation(t) {
    if (t?.ffmpeg && !this.ffmpegPath) throw new Error("FFmpeg path is not set");
    let r = (0, import_child_process.spawnSync)(this.binaryPath, ["--version"], { stdio: "ignore" }), s = t?.ffmpeg ? (0, import_child_process.spawnSync)(this.ffmpegPath, ["-version"], { stdio: "ignore" }) : { status: 0 };
    return r.status === 0 && s.status === 0;
  }
  async getInfoAsync(t, r) {
    let s = await this.execAsync(t, { dumpSingleJson: true, flatPlaylist: true, ...r });
    return JSON.parse(s.output);
  }
  async execAsync(t, r) {
    let s = new P(t, { binaryPath: this.binaryPath, ffmpegPath: this.ffmpegPath }), { onData: i, onProgress: n, onBeforeDownload: o, pipeTo: a, ...u } = r || {};
    return u && s.options(u), i && s.on("stdout", i), n && s.on("progress", n), o && s.on("beforeDownload", o), a ? s.pipe(a) : s.exec();
  }
  exec(t, r) {
    let s = new P(t, { binaryPath: this.binaryPath, ffmpegPath: this.ffmpegPath });
    return r && s.options(r), s;
  }
  download(t, r) {
    let s = new _(t, { binaryPath: this.binaryPath, ffmpegPath: this.ffmpegPath }), { format: i, ...n } = r || {};
    return i && s.format(i), n && s.options(n), s;
  }
  async downloadAsync(t, r) {
    let { onProgress: s, beforeDownload: i, ...n } = r || {}, o = this.download(t, n);
    s && o.on("progress", s), i && o.on("beforeDownload", i);
    let a = await o.run();
    return { output: a.output, filePaths: a.filePaths, info: a.info };
  }
  stream(t, r) {
    let s = new R(t, { binaryPath: this.binaryPath, ffmpegPath: this.ffmpegPath }), { format: i, ...n } = r || {};
    return i && s.format(i), n && s.options(n), s;
  }
  execBuilder(t, r) {
    let s = new P(t, { binaryPath: this.binaryPath, ffmpegPath: this.ffmpegPath }), { format: i, ...n } = r || {};
    return i && s.format(i), n && s.options(n), s;
  }
  async downloadAudio(t, r = "mp3", s) {
    let i = ["aac", "flac", "mp3", "m4a", "opus", "vorbis", "wav", "alac"];
    if (!i.includes(r)) throw new Error(`Invalid audio format: ${r}. Supported: ${i.join(", ")}`);
    return this.downloadAsync(t, { ...s, extractAudio: true, audioFormat: r });
  }
  async downloadVideo(t, r = "best", s) {
    let i = ["best", "2160p", "1440p", "1080p", "720p", "480p", "360p", "240p", "144p", "highest", "lowest"];
    if (!i.includes(r)) throw new Error(`Invalid video quality: ${r}. Supported: ${i.join(", ")}`);
    let n = r === "best" ? "bestvideo+bestaudio/best" : `bestvideo[height<=${parseInt(r) || 1080}]+bestaudio/best[height<=${parseInt(r) || 1080}]`;
    return this.downloadAsync(t, { ...s, format: n });
  }
  async getSubtitles(t, r) {
    let s = await this.execAsync(t, { ...r, dumpSingleJson: true, skipDownload: true });
    if (!s.output) return [];
    try {
      let i = JSON.parse(s.output), n = (o, a) => Object.entries(o || {}).flatMap(([u, l]) => Array.isArray(l) ? l.flatMap((f) => {
        if (!f || typeof f != "object") return [];
        let d = f, p = d.ext;
        return typeof p != "string" ? [] : [{ language: u, languages: [u], ext: p, autoCaption: a, ...typeof d.url == "string" ? { url: d.url } : {}, ...typeof d.name == "string" ? { name: d.name } : {} }];
      }) : []);
      return [...n(i.subtitles, false), ...n(i.automatic_captions, true)];
    } catch {
      return [];
    }
  }
  async getComments(t, r = 20, s) {
    let i = await this.execAsync(t, { ...s, writeComments: true, dumpSingleJson: true, skipDownload: true, extractorArgs: { youtube: [`max_comments=${r}`, "player_skip=webpage"] } });
    try {
  ...
  async getDirectUrlsAsync(t, r) {
    return (await this.getInfoAsync(t, r)).formats.map((i) => i.url);
  }
  async getFormatsAsync(t, r) {
    let s = await this.getInfoAsync(t, r);
    return { source: "json", info: s, formats: s.formats };
  }
  async getThumbnailsAsync(t) {
    return (await this.getInfoAsync(t)).thumbnails;
  }
  async getTitleAsync(t) {
    return (await this.execAsync(t, { print: "title" })).output.trim();
  }
  async getVersionAsync() {
    if (!this.binaryPath) throw new Error("yt-dlp binary path is not set");
    return this.getVersionAsyncUsingBinary(this.binaryPath);
  }
  async downloadFFmpeg() {
    return G();
  }
  async getFileAsync(t, r) {
    let s, { onBeforeDownload: i, onProgress: n, filename: o, metadata: a, format: u, ...l } = r || {}, f = [], d = new import_stream.PassThrough();
    d.on("data", (v) => f.push(Buffer.from(v)));
    let p = B(u), E = { ...l };
    if (p.length >= 2 && p[0] === "-f" && (E.format = p[1]), p.includes("--merge-output-format")) {
      let v = p.indexOf("--merge-output-format");
      E.mergeOutputFormat = p[v + 1];
    }
    await this.execAsync(t, { ...E, noPlaylist: true, pipeTo: d, onProgress: n, onBeforeDownload: (v) => {
      s = v, i?.(v);
    }, output: "-" });
    let O, U;
    u && typeof u == "object" ? (O = W(u), U = J(u)) : (O = ne(l) || "video/mp4", U = oe(l) || "mp4");
    let ve = new import_buffer.Blob(f, { type: O }), te = { name: o || `${s?.title || "download"}.${U}`, type: O, size: ve.size, ...a };
    return new File([Buffer.concat(f)], te.name, { type: te.type });
  }
  async getUrlsAsync(t, r) {
    return (await this.execAsync(t, { ...r, print: "urls" })).output.split(`
`).filter(Boolean);
  }
  async updateYtDlpAsync(t) {
    if (t?.preferBuiltIn !== false && this.binaryPath) try {
    ...
    let s = t?.outDir || (this.binaryPath ? import_path2.default.dirname(this.binaryPath) : void 0);
    if (t?.verifyChecksum !== false) {
      let a = await Z(s), u = await this.getVersionAsyncUsingBinary(a.path).catch(() => {
      });
      return { method: "download", binaryPath: a.path, version: u, verified: a.verified };
    }
    let n = await N(s), o = await this.getVersionAsyncUsingBinary(n).catch(() => {
    });
    return { method: "download", binaryPath: n, version: o, verified: false };
  }
  async getVersionAsyncUsingBinary(t) {
    return new Promise((r, s) => {
      let i = (0, import_child_process.spawn)(t, ["--version"]), n = "", o = "";
      i.stdout?.on("data", (a) => {
        n += a.toString();
      }), i.stderr?.on("data", (a) => {
        o += a.toString();
      }), i.on("close", (a) => {
        a === 0 ? r(n.trim()) : s(new Error(`Failed to get version: ${o}`));
      }), i.on("error", s);
    });
  }
};

// scripts/utils/Bases/ffmpeg/resize/merge/index.ts
var import_fs9 = __toESM(require("fs"));
var import_fluent_ffmpeg7 = __toESM(require_fluent_ffmpeg2());
var import_path11 = __toESM(require("path"));

// scripts/utils/Bases/ffmpeg/merge/continueDownloading.ts
var import_fluent_ffmpeg3 = __toESM(require_fluent_ffmpeg2());
var import_fs4 = __toESM(require("fs"));
var import_path6 = __toESM(require("path"));

// scripts/utils/ffmpeg.ts
var import_fluent_ffmpeg = __toESM(require_fluent_ffmpeg2());
var import_fs2 = __toESM(require("fs"));
var import_path4 = __toESM(require("path"));
var import_os = __toESM(require("os"));
var tempDir = import_os.default.tmpdir();
import_fluent_ffmpeg.default.setFfmpegPath(process.env.ffmpegPath);
import_fluent_ffmpeg.default.setFfprobePath(process.env.ffmpegProbe);
async function getFrameScreenShot(videoPath) {
  ...
  return await new Promise((res, rej) => {
    const tempThumbnailPath = import_path4.default.join(tempDir, `temp_thumbnail_${v4_default()}.png`);
    (0, import_fluent_ffmpeg.default)(videoPath).on("end", () => {
      if (!import_fs2.default.existsSync(tempThumbnailPath)) return rej("unfounded image");
      const data = import_fs2.default.readFileSync(tempThumbnailPath);
      import_fs2.default.unlinkSync(tempThumbnailPath);
      res(data.toString("base64"));
    }).on("error", (err) => {
      rej("Error generating thumbnail: " + err.message);
    }).screenshot({
      filename: import_path4.default.basename(tempThumbnailPath),
      folder: import_path4.default.dirname(tempThumbnailPath),
      timestamps: [time],
      fastSeek: true
    });
  });
}
function getVideoInfo(path8) {
  return new Promise((res, rej) => {
    import_fluent_ffmpeg.default.ffprobe(path8, (err, metadata) => {
      if (err) rej(err);
      res(metadata);
    });
  });
...
// scripts/utils/Bases/ffmpeg/continueDownloading.ts
var import_fluent_ffmpeg2 = __toESM(require_fluent_ffmpeg2());
var import_fs3 = __toESM(require("fs"));
var import_path5 = __toESM(require("path"));
function getTempName(orgPath) {
  const dir = import_path5.default.dirname(orgPath);
  const baseName = import_path5.default.basename(orgPath, import_path5.default.extname(orgPath));
  const newFileName = `${baseName}.temp${import_path5.default.extname(orgPath)}`;
  return import_path5.default.join(dir, newFileName);
}
async function continueDownloading(org, continued, start, duration) {
  const tempPath = getTempName(continued);
  import_fs3.default.renameSync(continued, import_path5.default.basename(tempPath));
  ...
  return (0, import_fluent_ffmpeg2.default)().input(tempPath).inputOptions(`-t ${resumePoint}`).input(org).setStartTime(start + resumePoint).inputOptions(duration ? [`-t ${duration - resumePoint}`] : []).on("end", () => {
    import_fs3.default.unlinkSync(tempPath);
  });
}

// scripts/utils/Bases/ffmpeg/merge/continueDownloading.ts
async function continueDownloading2(org, continued, start, duration) {
  const tempPath = getTempName(continued);
  import_fs4.default.renameSync(continued, import_path6.default.basename(tempPath));
  const info = await getVideoInfo(tempPath);
  const outputDuration = info.format.duration;
  const resumePoint = outputDuration > 5 ? outputDuration - 5 : 0;
  return (0, import_fluent_ffmpeg3.default)().input(tempPath).inputOptions(`-t ${resumePoint}`).input(org.video).setStartTime(start + resumePoint).inputOptions(`-t ${duration - resumePoint}`).input(org.audio).setStartTime(start + resumePoint).inputOptions(`-t ${duration - resumePoint}`).on("end", () => {
    import_fs4.default.unlinkSync(tempPath);
  });
}

// scripts/utils/Bases/ffmpeg/merge/index.ts
var import_fs8 = __toESM(require("fs"));
var import_fluent_ffmpeg6 = __toESM(require_fluent_ffmpeg2());
var import_path10 = __toESM(require("path"));

// scripts/utils/Bases/ffmpeg/resize/index.ts
var import_fs7 = __toESM(require("fs"));
var import_fluent_ffmpeg5 = __toESM(require_fluent_ffmpeg2());
var import_path9 = __toESM(require("path"));

// scripts/utils/Bases/ffmpeg/index.ts
var import_fluent_ffmpeg4 = __toESM(require_fluent_ffmpeg2());
  ...
  return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
    ...
    if (socketPath) {
      ...
      if (allowedSocketPaths != null) {
        ...
        const resolvedSocket = (0, import_path7.resolve)(socketPath);
        const isAllowed = allowed.some(
          (entry) => typeof entry === "string" && (0, import_path7.resolve)(entry) === resolvedSocket
        );
        if (!isAllowed) {
          return reject(
            new AxiosError_default(
...
// scripts/utils/Bases/link/index.ts
...
var HttpsDownloadAgent = new import_https2.default.Agent({
  rejectUnauthorized: false
  // (NOTE: this will disable client verification)
});
var HttpDownloadAgent = new import_http4.default.Agent({});
var DownloadInstance = axios_default.create({
...
// scripts/utils/Bases/index.ts
var import_events2 = __toESM(require("events"));
var import_fs5 = __toESM(require("fs"));
var DownloadBase = class extends import_events2.default {
  constructor({ downloadingState }) {
    super();
    this.enableThrottle = false;
    this.downloadingState = downloadingState;
    this.curSize = import_fs5.default.existsSync(this.downloadingState.path) ? import_fs5.default.statSync(this.downloadingState.path).size : 0;
    this.setCurSize(this.curSize);
  }
  static async getEstimatedFileSize(data, duration) {
    return null;
  }
  async download(func) {
    throw new Error("unimplemented function");
  }
  setPauseButton(state, enabled = true) {
    this.emit("setPauseButton", state, enabled);
  }
  setFileSize(size) {
    this.emit("setFileSize", size);
  }
  setResumability(state) {
  ...
  wrap(base) {
    base.on(
      "setPauseButton",
      (state, enabled) => this.setPauseButton(state, enabled)
    );
    base.on("setFileSize", (size) => this.setFileSize(size));
    base.on("setResumability", (state) => this.setResumability(state));
    base.on("changeState", (state) => this.changeState(state));
    base.on("setCurSize", (size) => this.setCurSize(size));
    base.on(
      "setThrottleState",
      (state) => this.setThrottleState(state)
    );
    base.on("onGetChunk", (size) => this.onGetChunk(size));
    base.on("resetSpeed", () => this.resetSpeed());
  }
  async pipe(path8) {
    this.emit("pipe", path8);
    return new Promise((res, rej) => {
      this.once("pipe", res);
      this.once("error", rej);
    });
...
// scripts/utils/Bases/link/index.ts
var HttpsDownloadAgent2 = new import_https4.default.Agent({
  rejectUnauthorized: false
  // (NOTE: this will disable client verification)
});
var HttpDownloadAgent2 = new import_http6.default.Agent({});
var DownloadInstance2 = axios_default.create({
  httpsAgent: HttpsDownloadAgent2,
  httpAgent: HttpDownloadAgent2
});
async function DownloadTheFile(link, range) {
  ...
  if (!response.statusCode || response.statusCode >= 300) {
    switch (response.statusCode) {
      ...
      default:
        throw new Error(
          `Sever Failed With Status Code:${response.statusCode || "unrecognized status code"}`
        );
    }
  }
  return response;
}
var LinkDownloadBase = class _LinkDownloadBase extends DownloadBase {
  constructor(data) {
    super(data);
  ...
  static async getEstimatedFileSize(data, duration) {
    ...
    const res = await DownloadInstance2.head(data.link, {
  ...
  async download(func) {
    ...
    const res = await DownloadInstance2.head(this.link, {
      validateStatus(status) {
        return status < 400;
      }
    });
    const contentSize = await _LinkDownloadBase.getEstimatedFileSize(this);
    if (contentSize) {
...
function isFile2(link) {
  try {
    return import_fs6.default.statSync(link).isFile();
  } catch (error) {
    return false;
  }
}
var FfmpegBase = class _FfmpegBase extends LinkDownloadBase {
  constructor(data) {
    super(data);
  ...
  static async getEstimatedFileSize(data, duration) {
    ...
    const EstimatedDuration = duration ?? (metadata.format.duration ? parseFloat(metadata.format.duration.toString()) : 0);
    if (!EstimatedDuration || !metadata.format.bit_rate) {
      return await _FfmpegBase.getEstimatedFileSize(data, duration);
    }
    const safeNum = (n) => n ? parseFloat(n.toString()) : 0;
    const videoStream = metadata.streams?.find((s) => s.codec_type === "video");
    const audioStream = metadata.streams?.find((s) => s.codec_type === "audio");
    let videoBitrate = safeNum(videoStream?.bit_rate) || safeNum(metadata.format.bit_rate);
  ...
  async continuoDownloading(command) {
    ...
    const numberOfFrames = parseInt(
      metaData.streams.find((formate) => formate.codec_type == "video")?.nb_frames || ""
    ...
    const commando = command.inputOption("-y").outputOptions("-movflags frag_keyframe+empty_moov").outputOptions("-c copy").on("error", (err) => this.error(err)).on("progress", ({ timemark, ...percent }) => {
      if (this.rebuildingState && timeStringToSeconds(timemark) > duration) {
        this.setPauseButton("Pause");
        this.rebuildingState = false;
        this.setThrottleState(this.enableThrottle);
      }
    ...
    const transfer = new import_stream6.PassThrough();
    commando.mergeToFile(transfer, import_path8.default.dirname(this.downloadingState.path));
    this.once("close", () => {
      try {
  ...
  async prepareDownloading(command) {
    this.setCurSize(0);
    this.changeState("connecting");
    ...
    try {
      ...
      numberOfFrames = Math.floor(
        parseInt(
          metaData.streams.find((formate) => formate.codec_type == "video")?.nb_frames || "60"
        ) * ((this.ffmpegData?.duration || duration) / duration)
      );
    } catch (error) {
    }
    ...
    command.inputOption("-y").outputOptions(
      this.ffmpegData?.duration ? [
        `-t ${this.ffmpegData.duration}`
        // Set duration for both video and audio
      ] : []
    ).outputOptions("-movflags frag_keyframe+empty_moov").outputOptions("-c copy").on("progress", (progress) => {
      if (progress.frames) {
        const fileSize = numberOfFrames / progress.frames * progress.targetSize * 1024;
        this.setFileSize(fileSize);
      }
    }).on("start", () => {
      this.setPauseButton("Pause");
  ...
  async converting() {
    ...
    await new Promise((res, rej) => {
      const command = (0, import_fluent_ffmpeg4.default)().input(tempPath).outputOptions("-movflags +faststart").outputOptions("-c copy").on("progress", (progress) => {
        const targetSize = progress.targetSize * 1024;
        this.changeState("receiving");
        this.setFileSize(void 0);
  ...
  async download(func) {
    if (!this.ffmpegData && !this.editData && (!this.link || !isFile2(this.link)))
      return await super.download(func);
    const format = import_path8.default.extname(this.downloadingState.path).slice(1);
    this.setFileSize(
      await _FfmpegBase.getEstimatedFileSize(
        this,
        this.ffmpegData?.duration
      ) || void 0
    );
    if (this.downloadingState.continued && import_fs6.default.existsSync(this.downloadingState.path)) {
      const command = (await continueDownloading(
        this.link,
        this.downloadingState.path,
        this.ffmpegData?.start || 0,
        this.ffmpegData?.duration
      )).format(format);
      const stream4 = await this.continuoDownloading(command);
      await pipeAsync(stream4.pipe.pipe(func(stream4.path)));
    } else {
      await new Promise(async (res, rej) => {
        const command = (0, import_fluent_ffmpeg4.default)().input(this.link).seekInput(this.ffmpegData?.start ?? 0).format(format).on("end", res).on("error", rej);
        const stream4 = await this.prepareDownloading(command);
        await pipeAsync(stream4.pipe.pipe(func(stream4.path)));
      });
    }
...
// scripts/utils/Bases/ffmpeg/resize/index.ts
var FfmpegResizeBase = class _FfmpegResizeBase extends FfmpegBase {
  constructor(data) {
    super(data);
    this.rebuildingState = false;
  ...
  async continueDownResize(command) {
    const metaData = await getVideoInfo(this.downloadingState.path);
    const duration = metaData.format.duration;
    if (!duration) throw new Error("Unrecognized time");
    const numberOfFrames = parseInt(
    ...
    this.setThrottleState(this.enableThrottle);
    const commando = command.inputOption("-y").on("error", (err) => this.error(err)).on("progress", ({ timemark, ...percent }) => {
      if (this.rebuildingState && timeStringToSeconds(timemark) > duration) {
        this.setPauseButton("Pause");
        this.rebuildingState = false;
        this.setThrottleState(this.enableThrottle);
    ...
    commando.mergeToFile(
      this.downloadingState.path,
      import_path9.default.dirname(this.downloadingState.path)
    );
    this.once("close", () => {
      try {
        command.kill("SIGKILL");
  ...
  async prepareDownResize(command) {
    this.setCurSize(0);
    this.setResumability(true);
    this.changeState("connecting");
    this.setResumability(true);
  ...
  async download(func) {
    ...
    this.setFileSize(
      await _FfmpegResizeBase.getEstimatedFileSize(
        this,
        this.ffmpegData?.duration
      ) || void 0
    );
    const format = import_path9.default.extname(this.downloadingState.path).slice(1);
    if (this.downloadingState.continued && import_fs7.default.existsSync(this.downloadingState.path)) {
      const command = (await continueDownloading(
        this.link,
        this.downloadingState.path,
        this.ffmpegData?.start || 0,
        this.ffmpegData?.duration || 1e12
      )).format(format);
      if (this.editData?.audioOnly) command.noVideo();
      else if (this.editData?.videoOnly) command.noAudio();
      if (this.resize) command.videoFilters(`scale=-2:${this.resize}`);
      ...
      await new Promise(async (res, rej) => {
        const command = (0, import_fluent_ffmpeg5.default)().input(this.link).on("error", rej).on("end", res).setStartTime(this.ffmpegData?.start || 0);
...
// scripts/utils/Bases/ffmpeg/merge/index.ts
var FfmpegMergeBase = class _FfmpegMergeBase extends FfmpegResizeBase {
  constructor(data) {
    super(data);
  ...
  async prepareDownloading(command) {
    ...
    return super.prepareDownloading(command);
  }
  async download(func) {
    if (!this.mergeData) return await super.download(func);
    this.setFileSize(
      await _FfmpegMergeBase.getEstimatedFileSize(
        this,
        this.ffmpegData?.duration
      ) || void 0
    );
    const format = import_path10.default.extname(this.downloadingState.path).slice(1);
    if (this.downloadingState.continued && import_fs8.default.existsSync(this.downloadingState.path)) {
      const stream4 = await super.continuoDownloading(
        (await continueDownloading2(
          {
      ...
      await pipeAsync(stream4.pipe.pipe(func(this.downloadingState.path)));
    } else {
      await new Promise(async (res, rej) => {
        const stream4 = await this.prepareDownloading(
          (0, import_fluent_ffmpeg6.default)().input(this.mergeData.videoLink).setStartTime(this.ffmpegData?.start || 0).input(this.mergeData.audioLink).setStartTime(this.ffmpegData?.start || 0).format(format).on("end", res).on("error", rej)
        );
        await pipeAsync(stream4.pipe.pipe(func(this.downloadingState.path)));
      });
    }
...
// scripts/utils/Bases/ffmpeg/resize/merge/index.ts
var FfmpegResizeMergeBase = class _FfmpegResizeMergeBase extends FfmpegMergeBase {
  constructor(data) {
    super(data);
  }
  async prepareDownResize(command) {
  ...
  async download(func) {
    ...
    this.setFileSize(
      await _FfmpegResizeMergeBase.getEstimatedFileSize(
        this,
        this.ffmpegData?.duration
      ) || void 0
    );
    const format = import_path11.default.extname(this.downloadingState.path).slice(1);
    if (this.downloadingState.continued && import_fs9.default.existsSync(this.downloadingState.path)) {
      ...
      await this.prepareDownResize(
        (0, import_fluent_ffmpeg7.default)().input(this.mergeData.videoLink).setStartTime(this.ffmpegData?.start || 0).input(this.mergeData.audioLink).setStartTime(this.ffmpegData?.start || 0).format(format)
      );
    }
    return this.downloadingState.path;
  }
...
// utils/time.ts
function convertSecondsToHHMMSS(durationInSeconds) {
...
// scripts/utils/Bases/ytdlp/index.ts
var import_os2 = __toESM(require("os"));
var ytdlp = new Pe({
  binaryPath: process.env.ytdlp_binDir,
  ffmpegPath: process.env.ffmpegPath
});
var YtdlpBase = class extends FfmpegResizeMergeBase {
  ...
  async download(func) {
    ...
    const ytdlpStream = ytdlp.stream(this.ytdlpData.link, {
      ...
      paths: `TEMP:${import_os2.default.tmpdir()}`,
      downloadSections: this.ffmpegData && `*${convertSecondsToHHMMSS(
...
// scripts/ytdlp/valid.ts
var PATH = "custom";

// utils/index.ts
async function asyncFindSequential(arr, asyncPredicate) {
...
// scripts/utils/func.ts
var import_child_process2 = require("child_process");
var import_os3 = __toESM(require("os"));
function getYtdlpStreams(url2) {
  return new Promise((resolve, reject) => {
    const args = [
      url2,
      "--dump-json",
      ...
      "node",
      "--paths",
      `TEMP:${import_os3.default.tmpdir()}`
    ];
    const proc = (0, import_child_process2.spawn)(process.env.ytdlp_binDir, args);
    let stdout = "";
    let stderr = "";
...
// scripts/ytdlp/data.ts
async function getVideoData(url2) {
  const data = await getYtdlpStreams(url2);
  const formats = data.formats.map((data2) => {
    return {
      ...data2,
      has_video: data2.height != void 0 || data2.vcodec != "none",
      has_audio: data2.acodec != "none",
      qualityLabel: data2.width != void 0 ? getQualityFromResolution(data2.width, data2.height).label : void 0,
      type: data2.ext,
      args: {
        format: data2.format_id
      }
    };
  });
  return { ...data, formats };
  ...
  const videos = [
    ...YtdpFormats.filter(
      ...
      return {
        ...
        id: `videoytdlp_${quality.qualityLabel}${v4_default()}`
      };
    })
  ].sort((a, b2) => {
    return b2.quality - a.quality;
  });
  const audios = [
    ...YtdpFormats.filter((v) => !v.has_video && v.has_audio).map((audio) => {
      return {
        ...
        text: {
          str: `${audio.ext?.toUpperCase()} - (${audio.acodec?.toUpperCase()}) ${audio.abr}kbps`
        },
        quality: audio.quality,
        id: `videoytdlp_${audio.quality}${v4_default()}`
      };
    })
  ];
  const others = [
    ...YtdpFormats.filter((v) => v.has_video && !v.has_audio).map((video) => {
      return {
        ...
        text: {
          str: `Video Only ${video.qualityLabel || video.format_id} ${video.vcodec ? `${video.vcodec.toUpperCase()}` : ""} (.${video.ext})`
        },
        quality: parseInt(video.qualityLabel),
        id: `videoytdlp_${video.qualityLabel}${v4_default()}`
      };
    })
  ].sort((a, b2) => {
    return b2.quality - a.quality;
...
// scripts/facebook/data.ts
async function getData2(query) {
  return getData({ link: `https://www.facebook.com/watch?v=${query.id}` });
}

// scripts/facebook/valid.ts
var PATH2 = "facebook";
function getFbVideoId(url2) {
  if (!url2 || typeof url2 !== "string") return null;
  url2 = url2.trim();
  try {
    const u = new URL(url2);
    const hostname = u.hostname.toLowerCase();
    if (!hostname.includes("facebook.com") && !hostname.includes("fb.watch") && !hostname.includes("fbcdn.net")) {
      return null;
    }
  } catch (e) {
  }
  try {
    const q2 = new URL(url2).searchParams;
    if (q2.has("v")) return q2.get("v");
    if (q2.has("story_fbid")) return q2.get("story_fbid");
  } catch (e) {
  }
  const fbWatch = url2.match(/fb\.watch\/([A-Za-z0-9_-]+)/);
  if (fbWatch) return fbWatch[1];
  const pathMatch = url2.match(
    /\/videos?\/([0-9]+)|\/video\.php|\/permalink\.php|\/story\.php/
  );
  if (pathMatch && pathMatch[1]) return pathMatch[1];
  const lastNum = url2.match(/(?:\/|^)([0-9]{6,})(?:\/|$|\?)/);
  if (lastNum) return lastNum[1];
  const anyV = url2.match(/[?&]v=([0-9]+)/);
  if (anyV) return anyV[1];
  return null;
}
async function navigate(str) {
...
function predictInputString(query) {
  const { id } = query;
  return `https://www.facebook.com/share/v/${id}/`;
}

// scripts/facebook/download.ts
