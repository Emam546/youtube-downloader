...
var X = __toESM(require("fs"), 1);
var import_path2 = __toESM(require("path"), 1);
var import_buffer = require("buffer");
var import_stream = require("stream");
var import_path3 = __toESM(require("path"), 1);
var import_fs = __toESM(require("fs"), 1);
var Se = __toESM(require("https"), 1);
var _e = __toESM(require("http"), 1);
var import_url2 = require("url");
var b = __toESM(require("fs"), 1);
var ue = __toESM(require("fs"), 1);
var D = __toESM(require("path"), 1);
var g = __toESM(require("fs"), 1);
...
var Fe = () => (0, import_url.fileURLToPath)("file://index.js");
var Ae = () => import_path.default.dirname(Fe());
var h = Ae();
function V(e) {
  let r = [];
...
function Y(e, r = {}) {
  return new Promise((t, s) => {
    let o = (new import_url2.URL(e).protocol === "https:" ? Se : _e).get(e, r, (a) => {
...
async function G(e) {
  ...
  try {
    ...
    let i = s.map((o) => `${Re}/${o}`), n = s.map((o) => import_path3.default.join(r, String(o.split("-").pop())));
    ...
    for (let o = 0; o < s.length; o++) {
      let a = i[o], u = n[o];
      console.log("Downloading...", import_path3.default.basename(a)), await k(a, u);
    }
...
function F() {
  try {
    ...
    let r = import_path3.default.join(w, String(e[0].split("-").pop()));
...
async function Ie(e) {
  return new Promise((r, t) => {
    let s = import_crypto3.default.createHash("sha256"), i = g.createReadStream(e);
...
var E = class extends x {
  ...
  startStream() {
    ...
    this.printDebugCommandLine(t), this.process = (0, import_node_child_process2.spawn)(this.binaryPath, t, { shell: false }), this.emit("start", s), this.process.stdout?.on("data", (n) => {
...
var P = class extends x {
  ...
  startStream() {
    ...
    let s = `${this.binaryPath} ${t.join(" ")}`;
    return this.printDebugCommandLine(t), this.process = (0, import_node_child_process3.spawn)(this.binaryPath, t, { shell: false }), this.emit("start", s), this.process.stdout?.on("data", (i) => {
...
var we = class {
  ...
  async checkInstallationAsync(r) {
    return new Promise((t, s) => {
      ...
      let i = (0, import_child_process.spawn)(this.binaryPath, ["--version"]), n = false, o = !r?.ffmpeg;
  ...
  async getFileAsync(r, t) {
    let s, { onBeforeDownload: i, onProgress: n, filename: o, metadata: a, format: u, ...l } = t || {}, f = [], d = new import_stream.PassThrough();
    ...
    let xe = new import_buffer.Blob(f, { type: O }), ee = { name: o || `${s?.title || "download"}.${W}`, type: O, size: xe.size, ...a };
...
`).filter(Boolean);
  ...
  async updateYtDlpAsync(r) {
    ...
    let s = r?.outDir || (this.binaryPath ? import_path2.default.dirname(this.binaryPath) : void 0);
  ...
  async getVersionAsyncUsingBinary(r) {
    return new Promise((t, s) => {
      let i = (0, import_child_process.spawn)(r, ["--version"]), n = "", o = "";
      i.stdout?.on("data", (a) => {
        n += a.toString();
      }), i.stderr?.on("data", (a) => {
        o += a.toString();
...
var FfmpegBase = class _FfmpegBase extends LinkDownloadBase {
  ...
  async continuoDownloading(command) {
    ...
    commando.mergeToFile(transfer, import_path7.default.dirname(this.downloadingState.path));
    this.once("close", () => {
      try {
...
var FfmpegResizeBase = class _FfmpegResizeBase extends FfmpegBase {
  ...
  async continueDownResize(command) {
    ...
    commando.mergeToFile(
      this.downloadingState.path,
      import_path8.default.dirname(this.downloadingState.path)
    );
    this.once("close", () => {
      try {
        command.kill("SIGKILL");
