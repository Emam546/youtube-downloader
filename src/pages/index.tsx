      ...
      <div className="container">
        <div className="tw-py-10 tw-px-6 tw-text-center">
          ...
          <p className="tw-font-medium">
            ...
            {data.siteName} supports downloading all video formats such as: MP4,
        ...
        <div className="tw-flex">
            ...
            <div>
              ...
              <ul className="tw-px-1">
                <li className="tw-py-1">
                  1 .Search by name or directly paste the link of video you want
                  to convert
                </li>
                <li className="tw-py-1">
                ...
                <li className="tw-py-1">
                  3 .Select the video/audio format you want to download, then
          ...
          <div className="tw-w-full sm:tw-w-6/12">
            <div>
              <h6 className="tw-my-1 tw-font-semibold tw-text-2xl">Features</h6>
              <ul className="tw-px-1">
                <li className="tw-py-1">
                  • Unlimited downloads and always free
                </li>
                <li className="tw-py-1">• High-speed video converter</li>
                <li className="tw-py-1">• No registration required</li>
                <li className="tw-py-1">
        ...
        <div className="tw-flex tw-my-5">
          <div className="tw-w-full sm:tw-w-4/12">
            <div className="tw-text-center tw-py-5 tw-px-3">
              <FontAwesomeIcon icon={faGift} className="tw-text-5xl tw-mb-3" />
